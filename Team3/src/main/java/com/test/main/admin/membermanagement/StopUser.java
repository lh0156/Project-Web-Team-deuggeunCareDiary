...
@WebServlet("/admin/membermanagement/stopuser.do")
public class StopUser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int result = dao.userstop(memberseq);
		
		req.setAttribute("result", result);
		//4
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/admin/membermanagement/stopuser.jsp");
