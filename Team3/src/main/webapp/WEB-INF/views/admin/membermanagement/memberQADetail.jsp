...
<link rel="stylesheet"
	href="/team3/asset/css/admin/memberQADetail.css">
<style>
	    #content{
            width: 100%;
        ...
        <div id="container">
                ...
                <div id="user-recode">
                    <div id="recode-menu">
                        ...
                        <div id="now-menu" onclick="location.href='/team3/admin/membermanagement/memberQADetail.do?memberseq=${memberseq}';">회원 문의내역</div>
